...
WORKDIR /root/
RUN wget -O - https://github.com/novnc/noVNC/archive/v1.2.0.tar.gz | tar -xzv -C /root/ && mv /root/noVNC-1.2.0 /root/novnc && ln -s /root/novnc/vnc.html /root/novnc/index.html
...
RUN wget "https://ftp.mozilla.org/pub/firefox/releases/81.0/win32/en-US/Firefox%20Installer.exe"
